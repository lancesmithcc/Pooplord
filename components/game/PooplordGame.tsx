...
const PooplordGame = () => {
  ...
  const handleTouchStart = useCallback((event: React.TouchEvent<HTMLDivElement>) => {
    ...
    touchStateRef.current = {
      ...
      charStartX: gameState.character.renderX ?? 0, // Use renderX with a fallback
      charStartY: gameState.character.renderY ?? 0, // Use renderY with a fallback
      isDragging: true,
    };
    event.preventDefault();
  }, [mapLoaded, gameState.character.renderX, gameState.character.renderY]);
